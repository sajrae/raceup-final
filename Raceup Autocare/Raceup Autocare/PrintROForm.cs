...
{
    public partial class PrintROForm : Form
    {
        CreateROform LR3;
        DBConnection dbcon = null;

        public PrintROForm(CreateROform showROInfo)
        {
            InitializeComponent();
            this.LR3 = showROInfo;
        }

        private void PrintROForm_Load(object sender, EventArgs e)
        {
