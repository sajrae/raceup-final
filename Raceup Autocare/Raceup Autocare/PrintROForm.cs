...
namespace Raceup_Autocare
{
    public partial class PrintROForm : Form
    {
        ...
        OleDbDataReader ServicepackageReader = null;
        private PrintROServiceForm printROServiceForm;
        ...
        private void ShowServiceTable()
        {
            ...
            OleDbDataAdapter dataAdapte3 = new OleDbDataAdapter("SELECT RO_Number, Service_Description, Service_Quantity, Service_Price, Total_Price FROM RepairOrderService Where CStr(RO_Number)  = '" + RONumberLabel.Text + "'", connection3);
